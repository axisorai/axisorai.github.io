...
import { ArrowRight, Building2, Users, TrendingDown, Zap, Shield, HeartHandshake } from "lucide-react";
...
const HowWeOffer = () => {
    ...
    const steps = [
        {
            icon: Building2,
            number: "01",
            title: t('howWeOffer.steps.step1.title'),
            description: t('howWeOffer.steps.step1.description'),
        },
        {
            icon: Users,
            number: "02",
            title: t('howWeOffer.steps.step2.title'),
            description: t('howWeOffer.steps.step2.description'),
        },
        {
            icon: TrendingDown,
            number: "03",
            title: t('howWeOffer.steps.step3.title'),
            description: t('howWeOffer.steps.step3.description'),
        },
        {
            icon: Zap,
            number: "04",
            title: t('howWeOffer.steps.step4.title'),
            description: t('howWeOffer.steps.step4.description'),
        },
    ];
    ...
    const benefits = [
        {
            icon: Shield,
            title: t('howWeOffer.benefits.benefit1.title'),
            description: t('howWeOffer.benefits.benefit1.description'),
        },
        {
            icon: HeartHandshake,
            title: t('howWeOffer.benefits.benefit2.title'),
            description: t('howWeOffer.benefits.benefit2.description'),
        },
    ];
                ...
                <section className="py-12 md:py-20 px-4 md:px-6">
                    <div className="container mx-auto text-center max-w-4xl">
                        <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 rounded-full bg-primary/10 border border-primary/20 backdrop-blur-md">
                            ...
                            <span className="text-sm text-primary font-medium">{t('howWeOffer.badge')}</span>
                        </div>
                                        ...
                                        <div className="flex-1">
                                            <div className="flex items-center gap-3 mb-2">
                                                <span className="text-xs font-bold text-primary/60 uppercase tracking-wider">
                                                    {t('howWeOffer.stepLabel')} {step.number}
                                                </span>
                                            </div>
                    ...
                    <div className="container mx-auto max-w-2xl text-center">
                        <div className="glass-card-featured p-8 md:p-12">
                            <h2 className="text-2xl md:text-3xl font-semibold text-foreground mb-4">
                                {t('howWeOffer.cta.title')}
                            </h2>
                            <p className="text-muted-foreground/80 mb-8">
                                {t('howWeOffer.cta.description')}
                            </p>
                            <Link
                                to="/solutions"
