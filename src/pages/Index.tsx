    ...
    return (
        <div className="min-h-screen bg-background relative overflow-hidden">
            ...
            <main className="relative z-10 pt-24 pb-16">
                ...
                <section className="flex flex-col items-center justify-center pt-8 pb-0 md:pt-12 md:pb-0 px-4 md:px-6">
                ...
                <section id="technologies" className="pt-0 pb-10 md:pt-2 md:pb-16 px-4 md:px-6">
